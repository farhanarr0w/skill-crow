...
class SendInvitedContract extends StatefulWidget {
  const SendInvitedContract({super.key});

  @override
  State<SendInvitedContract> createState() => _SendInvitedContractState();
}

class _SendInvitedContractState extends State<SendInvitedContract> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Invite Freelancer"),
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(builder: (context) => FreelancerProfileView()),
              (route) => false,
            );
          },
        ),
